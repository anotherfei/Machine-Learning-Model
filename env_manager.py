...
ALLOWED = set(REQUIRED + ("PG_PORT", "PG_COL_TIMESTAMP", "PG_COL_A_RMS_MPS2", "PG_COL_V_RMS_MMS", "PG_COL_A_PEAK_MPS2", "PG_COL_CREST_FACTOR", "PG_COL_TEMPERATURE_C", "APP_SECRET_KEY", "FRONTEND_ORIGIN", "COOKIE_SECURE", "BOOTSTRAP_ADMIN_USER", "BOOTSTRAP_ADMIN_PASSWORD"))
